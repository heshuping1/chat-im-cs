...
export const workbenchShortcuts: WorkbenchShortcut[] = [
  ...
  },
  {
    ...
    roles: ["admin", "owner"],
    groupKey: "admin",
    titleKey: "workbench.shortcut.wb-admin-customers.title",
    descriptionKey: "workbench.shortcut.wb-admin-customers.description",
    state: "pending_api",
  },
  {
  ...
  },
  {
    ...
    roles: ["admin", "owner"],
    groupKey: "admin",
    titleKey: "workbench.shortcut.wb-admin-groups.title",
    descriptionKey: "workbench.shortcut.wb-admin-groups.description",
    state: "pending_api",
  },
  {
    ...
    roles: ["admin", "owner"],
    groupKey: "admin",
    titleKey: "workbench.shortcut.wb-owner-broadcast.title",
    descriptionKey: "workbench.shortcut.wb-owner-broadcast.description",
    state: "pending_api",
  },
];
