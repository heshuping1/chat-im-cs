...
export const customerServiceLifecycleEventNames = [
  ...
  "temp_session.transferred",
  "temp_session.closed",
  "temp_session.reopened",
  "temp_session.resumed",
  "temp_session.rated",
  "customer_service.assigned",
  "customer_service.transferred",
  "customer_service.thread.transferred",
  "customer_service.reopened",
  "customer_service.resumed",
  "customer_service.thread.reopened",
  "customer_service.thread.resumed",
...
>([
  ...
  ["temp_session.transferred", "thread_transferred"],
  ["temp_session.closed", "thread_closed"],
  ["temp_session.reopened", "thread_reopened"],
  ["temp_session.resumed", "thread_reopened"],
  ["temp_session.rated", "thread_rated"],
  ["customer_service.assigned", "thread_assigned"],
  ["customer_service.transferred", "thread_transferred"],
  ["customer_service.thread.transferred", "thread_transferred"],
  ["customer_service.reopened", "thread_reopened"],
  ["customer_service.resumed", "thread_reopened"],
  ["customer_service.thread.reopened", "thread_reopened"],
  ["customer_service.thread.resumed", "thread_reopened"],
