...
export function LoginPage() {
  ...
  const applyDirectSession = async (baseUrl: string, login: PlatformLoginResult) => {
    ...
    setAuthSession({
      ...
      platformRefreshTokenExpiresAt: login.platformRefreshTokenExpiresAt,
      refreshToken: login.refreshToken,
      deviceSessionToken: login.deviceSession?.deviceSessionToken,
      deviceSessionIssuedAt: login.deviceSession?.issuedAt,
      deviceSessionInactiveExpiresAt: login.deviceSession?.inactiveExpiresAt,
