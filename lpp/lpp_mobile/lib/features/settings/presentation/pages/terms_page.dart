    ...
    return Container(
      ...
      child: const Column(
        ...
        children: [
          ...
          SizedBox(height: 16),
          _Body(
            '欢迎您使用绿泡泡！在使用绿泡泡服务之前，请您仔细阅读本协议。本协议是您与绿泡泡科技有限公司（以下简称"我们"）之间关于您使用绿泡泡软件及相关服务所订立的协议。',
          ),
          SizedBox(height: 16),
          _Section('一、服务内容'),
          _Body(
            '1.1 绿泡泡是一款即时通讯应用，提供文字、语音、视频通话、文件传输等通讯服务。\n\n'
          ...
          _Section('二、账号注册与使用'),
          _Body(
            '2.1 您在使用本服务前需要注册一个绿泡泡账号。账号注册时，您需要提供真实、准确、完整的个人信息。\n\n'
          ...
          _Section('四、知识产权'),
          _Body(
            '4.1 绿泡泡软件及相关服务中包含的所有内容，包括但不限于文字、图片、音频、视频、软件、程序、代码等，其知识产权均归我们所有。\n\n'
